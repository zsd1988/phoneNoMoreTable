    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            if(this.totalPages > 1){
                html.push(
                    '<div class="goPage">第<input class="pageNum" style="text-align: center" type="number" ' +
                    'onchange="TableFunc.gotoPage(this);" onfocus="this.select();" value="' + this.options.pageNumber + '">页</div>')
            }
            html.push(
