...
(function (window, document, Chartist) {
   ...
   * @return {Object} The consolidated options object from the defaults, systemManager and matching responsive options
   */
...
(function(window, document, Chartist) {
   ...
   * @param {Boolean} [override] If set to true, the passed options will be used to extend the options that have been configured already. Otherwise the chart default options will be used as the systemManager
  ...
  /**
   * Constructor of chart systemManager class.
   *
   * @param query
   * @param data
  ...
  // Creating the chart systemManager class
...
(function(window, document, Chartist){
  ...
  var defaultOptions = {
    ...
    showArea: false,
    // The systemManager for the area chart that will be used to close the area shape (is normally 0)
    areaBase: 0,
    ...
    data.raw.series.forEach(function(series, seriesIndex) {
      ...
      if(seriesOptions.showArea && axisY.range) {
        ...
        path.splitByCommand('M').filter(function onlySolidSegments(pathSegment) {
          ...
          // We then insert a new move that should start at the area systemManager and draw a straight line up or down
          // at the end of the path we add an additional straight line to the projected area systemManager value
  ...
  function createChart(options) {
    ...
    data.raw.series.forEach(function(series, seriesIndex) {
      ...
      data.normalized[seriesIndex].forEach(function(value, valueIndex) {
        ...
        // If bars are stacked we use the stackedBarValues reference and otherwise systemManager all bars off the zero line
