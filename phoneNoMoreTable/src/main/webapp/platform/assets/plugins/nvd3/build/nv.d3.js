...
nv.tooltip = nv.tooltip || {}; // For the tooltip systemSetting
...
nv.models.multiBar = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0}
        ...
        , getX = function(d) { return d.x }
        , getY = function(d) { return d.y }
        , forceY = [0] // 0 is forced by default.. this makes sense for the majority of bar graphs... userSystem can always do chart.forceY([]) to remove
        , clipEdge = true
        , stacked = false
...
nv.models.stackedArea = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0}
        ...
        , id = Math.floor(Math.random() * 100000) //Create semi-unique ID incase userSystem doesn't selet one
        , container = null
        , getX = function(d) { return d.x } // accessor to get the x value from a data point
        , getY = function(d) { return d.y } // accessor to get the y value from a data point
        , style = 'stack'
