//@ sourceURL=resourceDetail.js
function init_common_customer_resourceDetail(){
    var _projectClientId = GlobalData.currentJson
    var _data;
    init=function () {
        getDataByURL("/service/platform/login/customer/projectClient/get", {id:_projectClientId}, function (data) {
            _data = data.data;
