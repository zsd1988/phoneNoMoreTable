...
public class UserPhoneGetMessageThread extends Thread {
    private static Logger logger = Logger.getLogger(UserPhoneGetMessageThread.class);

    private UserPhoneSocket socket;
    public boolean isRun = true;
    public InputStream inputStream;

    public UserPhoneGetMessageThread(UserPhoneSocket socket) {
        this.socket = socket;
    }
