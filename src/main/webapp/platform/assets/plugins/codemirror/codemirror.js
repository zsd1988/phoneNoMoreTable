...
window.CodeMirror = (function() {
  ...
  function makeDisplay(place, docStart) {
    ...
    // Wraps everything that needs to exist inside the vertically-padded coordinate systemSetting
  ...
  function fromCoordSystem(cm, coords, context) {
    ...
    // First move into "page" coordinate systemSetting
    if (context == "page") {
      left -= pageScrollX();
      top -= pageScrollY();
  ...
  function onContextMenu(cm, e) {
    ...
    function rehide() {
      ...
      // Try to detect the userSystem choosing select-all
      if (display.input.selectionStart != null) {
  ...
  function highlightLine(cm, line, state, forceToEnd) {
    ...
    // Compute the systemManager array of styles
